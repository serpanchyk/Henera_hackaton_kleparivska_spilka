...
LED маски: `1000`, `1100`, `0000`, `ON`, `OFF`, `BLINK`.
...
**Кольори (для CV):** `led_lens_01` (index 0) = **зелений** anchor (завжди ON),
`led_lens_04` (index 1) = **червоний** signal (блимає стан). Колір задає плагін
`LedController.cc` за індексом. Розведення кольорів дає змогу CV розрізняти anchor/signal
