...
- Бінарні маски на кшталт `1100` та `1000`
- `ON`
- `OFF`
- `BLINK`

У поточній дво-LED моделі перший біт керує зеленим anchor-маячком, другий біт керує червоним signal-маячком, а третій і четвертий біти не використовуються.
